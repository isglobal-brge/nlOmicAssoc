...
The input data for nlAssoc is the following:
...
Results can be filtered using different parameters as the FDR adjusted p-value
...
brge.enwas <- nlOmicAssoc(object = data_m[1:n,],
                      covars = vars_df,
                      model = "ewas",
                      imp_method = 'pmm',
                      perc_imp = 70,
